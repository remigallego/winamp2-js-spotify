...
export const SET_KBPS = "SET_KBPS";
export const ADD_TRACK_FROM_URI = "ADD_TRACK_FROM_URI";
export const S_UPDATE_PLAYER_OBJECT = "S_UPDATE_PLAYER_OBJECT";
export const READY = "READY";

/* EXPLORER ACTION TYPES */
export const SET_SELECTED_EXPLORER = "SET_SELECTED_EXPLORER";
export const SET_ALBUMS_FROM_ARTIST = "SET_ALBUMS_FROM_ARTIST";
export const SET_TRACKS_FROM_ALBUM = "SET_TRACKS_FROM_ALBUM";
export const RESET_STATE = "RESET_STATE";
export const SET_CURRENT_ID = "SET_CURRENT_ID";
export const GO_PREVIOUS_VIEW = "GO_PREVIOUS_VIEW";
export const UNSET_FOCUS_EXPLORER = "UNSET_FOCUS_EXPLORER";
export const SET_ARTISTS_FROM_USER = "SET_ARTISTS_FROM_USER";
export const SET_TRACKS_FROM_PLAYLIST = "SET_TRACKS_FROM_PLAYLIST";
